...
def calcola_lista(stringa,arr):
    ...
    vertice_alto_destro=[spigolo_mid_destro_post_rot[0]-cat2,spigolo_mid_destro_post_rot[1]-cat1]
    vertice_basso_destro=[spigolo_mid_destro_post_rot[0]+cat2,spigolo_mid_destro_post_rot[1]+cat1]
    vertice_alto_sinistro=[spigolo_mid_sinistro_post_rot[0]-cat2,spigolo_mid_sinistro_post_rot[1]-cat1]
    vertice_basso_sinistro=[spigolo_mid_sinistro_post_rot[0]+cat2,spigolo_mid_sinistro_post_rot[1]+cat1]
